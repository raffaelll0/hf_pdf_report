...
#una volta fatto inizio ad inserire i dati che estrapolo dalle funzioni


#implemento i grafici(anche di prova)


#aggiungo header loghi dell'azienda (fase finale)
